...
########################################################################################################################
    ...
    def initialize_models(self):
        ...
        models = {
            "detector": {
                "url": "https://huggingface.co/MoazTD/FaceDeepFake_ITI/resolve/4a2929ed4b3636d8c5b07d244aa7fd43b41b4935/models/face_detection/yolov8n-face.onnx?download=true",
                "path": "yolov8n-face.onnx"
            },
            "landmark": {
                "url": "https://huggingface.co/MoazTD/FaceDeepFake_ITI/resolve/main/models/face_landmarks/lbfmodel.yaml?download=true",
                "path": "lbfmodel.yaml"
            },
            "swapper": {
