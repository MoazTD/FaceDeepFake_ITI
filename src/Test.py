...
class Ui_DeepFakeMainWindow(object):
    ...
    def retranslateUi(self, DeepFakeMainWindow):
        ...
        self.next_btn_1.setText(QCoreApplication.translate("DeepFakeMainWindow", u"Next: Face Detection", None))
        ...
        self.prev_btn_2.setText(QCoreApplication.translate("DeepFakeMainWindow", u"Previous: Input", None))
        self.next_btn_2.setText(QCoreApplication.translate("DeepFakeMainWindow", u"Next: Landmarks", None))
        ...
        self.landmark_model_combo.setItemText(0, QCoreApplication.translate("DeepFakeMainWindow", u"LBF Model", None))
        self.landmark_model_combo.setItemText(1, QCoreApplication.translate("DeepFakeMainWindow", u"AAM Model", None))
        self.landmark_model_combo.setItemText(2, QCoreApplication.translate("DeepFakeMainWindow", u"ERT Model", None))
